    ...
    <main className="min-h-screen bg-gray-950 text-white flex flex-col items-center p-6">
      <div className="w-full max-w-lg">
        <div className="flex items-center gap-3 mb-6">
          ...
          <h1 className="text-2xl font-black text-yellow-400">Edit Playlist</h1>
        </div>
        ...
        <div className="flex flex-col gap-2 mb-4">
          <label className="text-gray-400 text-sm">Add songs</label>
        ...
        {tracks.length > 0 && (
          <div className="flex flex-col gap-2 mb-6">
            <p className="text-gray-400 text-sm">{tracks.length} song{tracks.length !== 1 ? "s" : ""}</p>
            <div className="bg-gray-900 rounded-xl overflow-hidden divide-y divide-gray-800">
              {tracks.map((t, i) => (
